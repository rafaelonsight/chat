{{--
    ...
    Recebe $plataforma ('whatsapp' | 'instagram' | 'messenger') e, opcional, $classe.
...
@php
    ...
    $rotulos = ['whatsapp' => 'WhatsApp', 'instagram' => 'Instagram', 'messenger' => 'Messenger'];
@endphp

<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
     class="shrink-0 {{ $classe }} {{ $cor }}"
     role="img" aria-label="{{ $rotulos[$plataforma] ?? 'WhatsApp' }}">
    <title>{{ $rotulos[$plataforma] ?? 'WhatsApp' }}</title>
    <path d="{{ $caminho }}" />
</svg>
