<x-filament-panels::page>
    <div class="rounded-xl border border-dashed border-gray-300 p-10 dark:border-white/20">
        <p class="text-center text-base font-medium text-gray-700 dark:text-gray-200">Funcionários Digitais em construção</p>
        <p class="mx-auto mt-2 max-w-2xl text-center text-sm text-gray-500 dark:text-gray-400">Agentes de IA que conduzem atendimento como um membro da equipe.</p>
